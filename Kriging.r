    ...
    path = "/home/leonildo/Dropbox/ICMC-USP/Doutorado/codigos/Granularity/"  # (for example)
    setwd(path)
    #file <- "./preprocessing/pre-final-file.csv"
    file <- "./data/pollution_us_2019.csv"
    ...
    map <- readOGR(dsn = "./shapes/USA/USA-edited/USA.shp", verbose = FALSE, encoding = 'iso-8859-1', stringsAsFactors = FALSE)
